...
tpl:'<div class="profile-info-value">' +
        '<select name="province" id="province"><option value="1">北京</option></select>' +
        '<select name="" id=""></select>' +
        '<select name="" id=""></select>' +
        '<script>$("#province").select2({placeholder: "Select a state"});</script>' +
    '</div>',
        inputclass: ''
    });
